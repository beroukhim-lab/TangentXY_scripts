...
for (i in 1:length(n.num)) {
  ...
  N.m <- N[, normals.male[1:(n.num.i/2)]]
  ...
  saveRDS(Tn.m.normalized, file=here('04_TCGA_Tangent_vs_TangentXY/output/03_SexMatchedTangent_male', paste0('Tn_SMTangent_male_', n.num.i/2, '.rds')), compress=FALSE)
}
